...
new property to the object called yearBorn. The value of the yearBorn property should be 
...
Write a function that accepts two arrays. Append the values from the second array into 
the first,
